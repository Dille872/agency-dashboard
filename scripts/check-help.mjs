...
const PORTALE = [
  {
    ...
    collapsible: true,
    ankerlos: ['ueberblick', 'angebote', 'bell', 'chat', 'pinnwand', 'zeitzone', 'app', 'ueber'], // zeitzone: Hinweis sitzt in ZeitzonenHinweis.jsx · app: AppInstallieren.jsx · ueber: SteckbriefAnsicht.jsx
  },
  {
    name: 'Model-Portal',
